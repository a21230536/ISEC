...
main(int argc, char *argv[])
{
    ...
    if (argc < 4) {
        printf("> Sintaxe: %s <mensagem> <endereco ip> <porto>\n", argv[0]);
        exit(1);
    }
    ...
    /* receber datagrama (estrutura sockaddr_in) */
