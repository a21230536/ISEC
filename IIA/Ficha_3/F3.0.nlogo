...
to setup-patches
  ...
  ask patches with [pcolor = black][
     if random 101 < 5 [set pcolor red];; armadilhas
  ]

  ;; passo 2
  ask patches with [pcolor = black][
     if random 101 < 15 [set pcolor green];; comida
  ]
...
to move-ants
    ask ants[
      ;; tem armadilha na patch à frente
      ifelse [pcolor] of patch-ahead 1 = red [
        ;; virar 90 graus
        rt 90
      ][
        ;; passo 5d (tem caracol na patch em frente e já comeu cap-max patches de relva)
        ifelse any? snails-on patch-ahead 1 and n-relva >= cap-max [
          ;; seja caracol um dos snails na patch da frente
          let caracol one-of snails-on patch-ahead 1
          set energia energia + [energia] of caracol
          ask caracol [die]
          set n-relva 0
        ][
          ...
          ifelse [pcolor] of patch-ahead 1 = blue [
            ...
            ifelse [pcolor] of patch-ahead 1 = green and n-relva < cap-max [
              ...
              ;; Passo 5
              set n-relva n-relva + 1
            ][
              ;; a patch em frente é preta (ou amarela)
              ifelse random 100 < 90 [;; 90%
                ;; avança em frente
                fd 1
              ][;; 10%
                ;; 5% (50% dos 10%)
                ifelse random 100 < 50[
                  ...
                  ;; vira 90 graus à esquerda (restantes 5%)
                  lt 90 ;; lt => left turn
                ]
              ]
            ]
...
to mimetism
  ask ants[
    ifelse any? snails-on neighbors4 [
      set color yellow
    ][
    set color blue
    ]
