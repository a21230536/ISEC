...
to Paint
  ...
  if (Paint_Patches = "Forward")
    [
      ...
      ask turtle 0 [
        ask patch-ahead 1 [set pcolor 0]  
      ]
    ] 
  ...
  if (Paint_Patches = "Neighbor_8")[
    ;; coloca a preto as patches à volta do agente
    ask turtle 0 [
      ask neighbors [
        set pcolor black
      ]
  ...
  if (Paint_Patches = "Forward_3")[
    ask turtle 0 [
      ;; coloca a preto a patch 45 graus à direita e em frente do agente
      ...
      ;; coloca a preto a patch 45 graus à esquerda em frente do agente
